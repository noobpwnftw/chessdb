...
PHP_FUNCTION(xxhash32)
{
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS(), "s", &arg1, &arg1_len) == FAILURE || arg1_len < 1)
	{
		RETURN_NULL();
	}
...
zend_function_entry xxhash_functions[] = {
	PHP_FE(xxhash32, arginfo_xxhash32)
	PHP_FE(xxhash64, arginfo_xxhash64)
	PHP_FE(xxhash64Unsigned, arginfo_xxhash64Unsigned)
	{NULL, NULL, NULL}
};
