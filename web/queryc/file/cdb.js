...
function GetMoveList(s) {
	...
	if( !Vhidescore.checked ) {
		s = '<table cellspacing="0" style="text-align:center;" class="movelist"><thead><tr style="height:26px;"><td><b>着法<\/b><\/td><td><b>排序<\/b><\/td><td><b>分数<\/b><\/td><td style="min-width:100px;padding-right:20px;"><b>备注<\/b><\/td><\/tr><\/thead><tbody style="height:600px">';
		var skip = 0;
