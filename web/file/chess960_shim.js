...
function listRights(R){ return Object.keys(R).sort(); }
...
Chess960.prototype.validate_fen = function (xfen) {
  ...
  if (parts.length > 2) {
    if (!/^(-|K?Q?k?q?|[A-Ha-h]{1,4})$/.test(parts[2])) return { valid:false, error_number:5, error:'3rd field (castling availability) is invalid.' };
