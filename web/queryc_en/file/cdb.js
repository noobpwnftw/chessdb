...
function ClearInner() {
	Vout.innerHTML = '<table cellspacing="0" style="text-align:center;" class="movelist"><thead><tr style="height:26px;"><td><b>Move<\/b><\/td><td><b>Rank<\/b><\/td><td><b>Score<\/b><\/td><td style="min-width:100px;padding-right:20px;"><b>Notes<\/b><\/td><\/tr><\/thead><\/table>';
}
...
{
	var s2 = '<table cellspacing="0" class="movelist" style="width:100%"><thead style="border-spacing: 2px;"><tr><td onClick="NavStep(\'-\')" id="gbck" class="mbutton">&nbsp;<<&nbsp;<\/td><td onClick="NavStep(\'+\')" id="gfwd" class="mbutton">&nbsp;>>&nbsp;<\/td><td onClick="PreviousStep()" id="undo" class="mbutton">&nbsp;Undo&nbsp;<\/td><\/tr><tr style="cursor: pointer;"><td colspan="3"><div style="margin-top:5px;" onClick="NavStep(0)">';
	if(curstep == 0) {
...
function GetMoveList(s) {
	...
	if( !Vhidescore.checked ) {
		s = '<table cellspacing="0" style="text-align:center;" class="movelist"><thead><tr style="height:26px;"><td><b>Move<\/b><\/td><td><b>Rank<\/b><\/td><td><b>Score<\/b><\/td><td style="min-width:100px;padding-right:20px;"><b>Notes<\/b><\/td><\/tr><\/thead><tbody style="height:600px">';
		var skip = 0;
